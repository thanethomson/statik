...
class TestSelfReferencingModels(unittest.TestCase):
    ...
    def test_self_referencing_models(self):
        ...
        children = parents[0].findall('ul/li')
        self.assertEqual('Child 1.1', children[0].text.strip())
        self.assertEqual('Child 1.2', children[1].text.strip())

        self.assertEqual('Parent 2', parents[1].text.strip())
        children = parents[1].findall('ul/li')
        self.assertEqual('Child 2.1', children[0].text.strip())
        self.assertEqual('Child 2.2', children[1].text.strip())
